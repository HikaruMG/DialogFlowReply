...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Owner\Desktop\Code Data\Flask U\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Owner\Desktop\Code Data\Flask U\venv\Scripts\deactivate.nu'
